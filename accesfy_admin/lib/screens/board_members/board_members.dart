import 'package:accesfy_admin/screens/board_members/members_table.dart';
...
class BoardPanelMembers extends StatefulWidget {
  GlobalKey<ScaffoldState> _scaffoldKey;

  BoardPanelMembers(this._scaffoldKey);

  @override
  _BoardPanelMembersState createState() => _BoardPanelMembersState();
}

class _BoardPanelMembersState extends State<BoardPanelMembers> {
                        ...
                        children: [
                          Align(
                            ...
                            child: Container(
                              ...
                              child: Text("Add Board Member",textAlign: TextAlign.center,style: Theme.of(context).textTheme.headline5!.apply(color: secondaryColor),),
                            ),
                          ),
                          Align(
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Header("Board Members",widget._scaffoldKey),
                      ...
                      Row(
                        ...
                        children: [
                          ElevatedButton.icon(
                            ...
                            onPressed: () {
                              _showAddBoardMemberDialog();
                            },
                            icon: Icon(Icons.add),
                            label: Text("Add Board Member"),
                          ),
                        ],
                      ),
                      SizedBox(height: defaultPadding),
                      BoardPanelMemberTable(),
