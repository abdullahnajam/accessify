              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Text(item.date, textAlign: TextAlign.end, style: TextStyle(fontSize: 12, color: isMe ? Color(0xffabc6ff) : MyColors.grey_40)),
                      Container(width: 3),
                      isMe ? Icon(Icons.done_all, size: 12, color: Color(0xffabc6ff),) : Container(width: 0, height: 0)
                    ],
                  )
                ],
              ),
