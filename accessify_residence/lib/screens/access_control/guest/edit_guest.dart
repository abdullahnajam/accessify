...
class _EditGuestState extends State<EditGuest> {
  ...
  void initState() {
    ...
    vehicleController.text=widget.model.vehicle;
                ...
                Container(
                    child: Column(
                      children: [
                        ...
                        Text("Your guest has been updated",style: TextStyle(fontSize: 13,fontWeight: FontWeight.w300),),
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            width: double.maxFinite,
                            alignment: Alignment.center,
                            child: Text("Update Guest",textAlign: TextAlign.center,style: TextStyle(color: Colors.white,fontSize: 20),),
                            decoration: BoxDecoration(
                                color: kPrimaryColor,
                                borderRadius: BorderRadius.circular(30)
                            ),
